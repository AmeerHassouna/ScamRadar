...
SCAM_PHRASES = [
    ...
    "top 10 reasons why", "top ten reasons why",
    "tired of boring", "tired of your boring",
    "tired of being average", "tired of being ordinary",
    "boring old social", "boring social media",
    "coolest kid on the block", "coolest cat on the",
    "hottest influencers", "hottest celebs",
    "hottest pics", "hottest videos",
    "gotchu fam", "i gotchu",
    "social peeps", "hey there social",
    "epic news peeps", "some epic news",
    "blow your mind and your",
    "wanna know the latest", "you wanna know the",
    "improve your social media game",
    "join our social network",
    "coolest cat", "the coolest kid",
    "hey friends are you", "hey there are you",
    "get ready for some", "ready for some epic",
    "want to be the coolest",
    "chance to join",
    "lit right now",
    "slide into", "slide into our",
    "socmed",
]
