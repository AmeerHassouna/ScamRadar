    ...
    return (
      ...
      >
        ...
        <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12">
          ...
          <div className="relative w-full h-[260px] sm:h-[350px] md:h-[450px] flex items-center justify-center">
            {/* Carousel Wrapper */}
              ...
              {images.map((image, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={cn(
                      'absolute w-32 h-56 sm:w-48 sm:h-96 md:w-64 md:h-[450px] transition-all duration-500 ease-in-out',
