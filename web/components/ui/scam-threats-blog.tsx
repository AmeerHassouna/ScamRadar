...
const posts = [
  ...
  },
  {
    ...
    summary:
      "Fake celebrity-endorsed giveaways spread via WhatsApp and Telegram, requesting a small 'verification' transfer to unlock fabricated winnings that never arrive.",
  ...
  },
  {
    ...
    summary:
      "Slow-burn romance-to-crypto scams build trust over weeks before introducing a 'private trading platform' that locks funds on withdrawal — losses averaging $120 k per victim.",
