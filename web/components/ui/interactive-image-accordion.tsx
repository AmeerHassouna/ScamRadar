...
const landingItems: AccordionData[] = [
  {
    ...
    description: 'Drop in any SMS, email, or chat snippet. You can paste a single message or a whole conversation.',
  ...
  },
  {
    ...
    step: '02',
    title: 'Tone signals',
    description: 'The model reads urgency, fear, reward, and threat — the psychological levers scammers rely on.',
  ...
  },
  {
    id: 3,
    step: '03',
    title: 'Links checked live',
    description: 'Any URLs get inspected for suspicious patterns and checked against Google Safe Browsing in real time.',
  ...
  },
  {
    id: 4,
    step: '04',
    title: 'AI reads the language',
    description: 'A model trained on hundreds of thousands of real messages reads the text and produces a scam probability — no database lookup, just learned patterns.',
    imageUrl: 'https://res.cloudinary.com/donzqvn9k/image/upload/e_grayscale/e_tint:60:1a5c37/f_auto,q_auto/v1786388264/4794a9b8ea09745b05f6cdd3e6f140b0_sscvot.jpg',
    icon: Cpu,
  },
  {
    id: 5,
    ...
    description: 'You get SCAM or LEGIT plus the signals that drove the call — tone breakdown, link status, and the scam type it looks like.',
