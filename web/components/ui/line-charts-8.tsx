...
const sparkCards = [
  {
    ...
    metric: 'Score deviation from decision threshold (t = 0.40)',
    baseValue: '92.4%',
  ...
  {
    title: 'External F1 Progression',
    metric: 'v1.0 → v1.3 on the leakage-free external set',
    baseValue: '0.624',
    baseCurrency: 'v1.0 baseline',
    targetValue: '0.873',
    targetCurrency: 'v1.3 shipped',
