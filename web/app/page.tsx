...
const teamMembers = [
  {
    ...
    quote: 'I built ScamRadar+ after a family member nearly lost money to a WhatsApp investment scam. No tool we found could explain *why* a message was suspicious — just binary labels. I wanted something that actually helps people understand what they\'re looking at.',
  ...
  },
  {
    ...
    quote: 'The hardest part wasn\'t the accuracy — it was making 46,360 messy, real-world messages speak to a single model. We trained on the actual language scammers use, not sanitised examples. That\'s what makes the difference.',
  ...
  },
  {
    ...
    quote: 'What impressed me most was the team\'s focus on explainability — not just "is this a scam?" but "why?". That\'s a much harder problem, and a much more valuable one for real users.',
